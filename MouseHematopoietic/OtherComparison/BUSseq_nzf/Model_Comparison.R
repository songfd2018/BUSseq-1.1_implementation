...
zerorate_rep_nd <- read.table("ZeroRate_hemat_nzf.txt")
...
zerorate_rep_or <- read.table("../../BUSseq/ZeroRate_hemat_v1.txt")
...
# ARI comparison
w_BUSseq <- unlist(read.table("../../Inference_K6/w_est.txt"))
ARI_BUSseq <- adjustedRandIndex(metadata$CellType,w_BUSseq)

w_BUSseq_nzf <- unlist(read.table("Inference_K6/w_est.txt"))
