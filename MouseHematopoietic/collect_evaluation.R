...
# Calculating the ARI by their own clustering methods
...
write.table(sil_tSNE_true,"Results/Silhouette_coefs_tSNE.txt",row.names = F)
...
jpeg("Image/hemat_boxplot_of_Silhouette_coefs_tSNE.jpg",width = 900, height = 600,quality = 100)
...
# Storing Silhouette coefficients of the first 10 PCs
...
jpeg("Image/boxplot_of_hemat_Silhouette_coefs_10PCs.jpg",width = 900, height = 600,quality = 100)
